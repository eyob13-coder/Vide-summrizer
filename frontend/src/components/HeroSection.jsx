...
const HeroSection = () => {
  return (
    <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      >
        <source src="/clipmind.mp4" type="video/mp4" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-white px-6">
        ...
        <div className="flex justify-center gap-4">
          <button className="btn-primary cursor-pointer">Try Demo</button>
          <button className="btn-secondary cursor-pointer">Learn More</button>
        </div>
      </div>
    </section>
  );
