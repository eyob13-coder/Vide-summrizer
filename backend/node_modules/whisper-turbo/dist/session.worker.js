...
export class Session {
    ...
    run(audio, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Result.ok(yield this.whisperSession.run(audio, options));
        });
    }
    stream(audio, raw_audio, options, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.whisperSession) {
                return Result.err(new Error("The session is not initialized. Call `initSession()` method first."));
            }
            return Result.ok(yield this.whisperSession.stream(audio, raw_audio, options, callback));
        });
    }
}
